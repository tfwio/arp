...
:: visual-studio 2013 may be in %programfiles% (without the x86)
...
msbuild DrumSynthPlug.sln /p:configuration=release /p:platform=win32 /nologo /noconsolelogger /fileLogger /v:quiet /flp:logfile=build-win.log;errorsonly 
