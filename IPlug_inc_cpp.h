...
#include "resource.h" // This is your plugin's resource.h
  ...
  #ifdef __MINGW32__
// for older compilers?
    // mingw seems to like __declspec(dllexport)---rather than this for x64 but I need to double-check
    #define EXPORT __attribute__ ((visibility("default")))
  #else
    #if ((_MSC_VER==1800) || (_MSC_VER==1900)) && _M_X64
    // using *.def file---no need to EXPORT
    #define EXPORT
    #else
